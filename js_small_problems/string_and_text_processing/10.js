...
INPUT: word, text
OUTPUT: text, with each instance of given word highlighted

RULES:
- highlighted means: enclose the word with two asteriks on each side and change every eltter to uppercase
